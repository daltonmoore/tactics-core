...
namespace Editor
{
    public abstract class HidingAttributeDrawer : PropertyDrawer
    {
        public static bool CheckShouldHide(SerializedProperty property)
        {
            try {
                ...
                var targetObject = Util.GetTargetObjectOfProperty(property);
                ...
                var customAttributes = field.GetCustomAttributes(typeof (HideIfAttribute), false);
                ...
                HideIfAttribute[] attachedAttributes = (HideIfAttribute[]) customAttributes;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        if (!CheckShouldHide(property)) {
            ...
            Type drawerType;
            var typeOfProp = Util.GetTargetObjectOfProperty(property).GetType();
